<div id="dashboard" class="content-section">
    ...
    <div class="header">
        <div class="left">
            <h1>Settings</h1>
            <ul class="breadcrumb">
                <li><a href="#" class="active">Manage system settings here.</a></li>
            </ul>
        </div>
        <a href="#" class="report">
            <i class='bx bx-cog'></i>
    ...
    <div class="bottom-data">
        <div class="settings">
            ...
            <div class="configurations">
                <p><strong>Site Title:</strong> Example Corp</p>
...
<div id="users" class="content-section" style="display: none;">
    <div class="header">
        <div class="left">
            ...
            <ul class="breadcrumb">
                <li><a href="#" class="active">Manage user accounts and permissions.</a></li>
            </ul>
        </div>
        <a href="#" class="report">
...
<div id="tickets" class="content-section" style="display: none;">
    <div class="header">
        <div class="left">
            ...
            <ul class="breadcrumb">
                <li><a href="#" class="active">Handle support requests and queries.</a></li>
            </ul>
        </div>
        <a href="#" class="report">
            <i class='bx bx-plus'></i>
